    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <p className="text-[13px] font-medium text-gray-500 flex items-center gap-1 leading-none">
            <span>{label}</span>
            {tooltip && (
              <span className="relative inline-flex items-center">
                <span className="inline-flex items-center justify-center w-3.5 h-3.5 text-[9px] bg-gray-200 text-gray-500 rounded-full cursor-help leading-none">
                  ?
                </span>
        ...
        <div
          className={`w-10 h-10 rounded-xl flex items-center justify-center ${BG_MAP[color]}`}
        >
          {icon}
        </div>
      </div>
