...
export default function CrawlForm({ onStart, isLoading }: CrawlFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const options =
      mode === "single" ? { depth: 0, maxPages: 1 } : { depth, maxPages };
      ...
      <div className="flex gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-4 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 outline-none transition-all"
            disabled={isLoading}
          />
        </div>
        <button
